...
| **Userspace** | 110 programs against a forked Rust `std`, including a shell with job control, globbing and scripting, a vi-like editor, a pager, `sed`, and the usual coreutils and network tools |
