...
pub use edos_rt::sys::{
    SYS_ACCEPT, SYS_ACCESS, SYS_BIND, SYS_CLOCK_GETTIME, SYS_CLOSE, SYS_CONNECT, SYS_DUP,
    SYS_DUP2, SYS_ERRNO, SYS_FCNTL, SYS_FORK, SYS_FSTATAT, SYS_FTRUNCATE, SYS_GETDENTS,
    SYS_GETPID, SYS_IOCTL, SYS_ISATTY, SYS_KILL, SYS_LISTEN, SYS_LIST_MOUNTS,
    SYS_LIST_PARTITIONS, SYS_LSEEK, SYS_MMAP, SYS_MOUNT, SYS_MSYNC, SYS_MUNMAP, SYS_NANOSLEEP,
    SYS_OPEN, SYS_OPENAT, SYS_PING, SYS_PIPE, SYS_POLL, SYS_READ, SYS_READLINK, SYS_READV,
    SYS_RECVFROM, SYS_RENAME, SYS_SCHED_YIELD, SYS_SENDTO, SYS_SETSOCKOPT, SYS_SHUTDOWN,
    SYS_SIGACTION, SYS_SOCKET, SYS_SPAWN, SYS_SPAWN2, SYS_STAT, SYS_STATFS, SYS_SYMLINK, SYS_SYNC,
    SYS_UTIMENSAT, SYS_WAIT_PID, SYS_WRITE, SYS_WRITEV, syscall0, syscall1, syscall2, syscall3,
