...
impl FileSystem for Fat32fs {
    fn list_files(&self, path: super::path::Path) -> Result<alloc::vec::Vec<super::FileInfo>, super::Error> {
        todo!()
    }

    fn read_bytes(&self, path: super::path::Path, offset: usize, count: usize) -> Result<alloc::vec::Vec<u8>, super::Error> {
        todo!()
    }

    fn write_bytes(&self, path: super::path::Path, offset: usize, data: alloc::vec::Vec<u8>) -> Result<u64, super::Error> {
        todo!()
    }
