...
use super::{
    SYS_ACCEPT, SYS_ACCESS, SYS_BIND, SYS_CHDIR, SYS_CLOCK_GETTIME, SYS_CLOCK_SETTIME, SYS_CLONE,
    SYS_CLOSE, SYS_CONNECT, SYS_DUP, SYS_DUP2, SYS_ERRNO, SYS_EXECVE, SYS_EXIT, SYS_FACCESSAT,
    SYS_FCNTL, SYS_FORK, SYS_FSTAT, SYS_FSTATAT, SYS_FSYNC, SYS_FTRUNCATE, SYS_FUTEX_WAIT,
    SYS_FUTEX_WAKE, SYS_GETCWD, SYS_GETDENTS, SYS_GETDNS, SYS_GETGID, SYS_GETPEERNAME, SYS_GETPGID,
    SYS_GETPID, SYS_GETRANDOM, SYS_GETSOCKNAME, SYS_GETSOCKOPT, SYS_GETUID, SYS_IOCTL, SYS_ISATTY,
    SYS_KILL, SYS_LIST_DIR, SYS_LIST_MOUNTS, SYS_LIST_PARTITIONS, SYS_LISTEN, SYS_LSEEK, SYS_MKDIR,
    SYS_MKDIRAT, SYS_MKFIFOAT, SYS_MMAP, SYS_MONOTONIC_TIME, SYS_MOUNT, SYS_MSYNC, SYS_MUNMAP,
    SYS_NANOSLEEP, SYS_NETINFO, SYS_OPENAT, SYS_OPENPTY, SYS_PING, SYS_PIPE, SYS_POLL, SYS_PREAD,
    SYS_PWRITE, SYS_READ, SYS_READLINK, SYS_READLINKAT, SYS_READV, SYS_REBOOT, SYS_RECVFROM,
    SYS_RENAME, SYS_RENAMEAT, SYS_RMDIR, SYS_RMDIR_ALL, SYS_SCHED_YIELD, SYS_SENDTO, SYS_SETPGID,
    SYS_SETSOCKOPT, SYS_SHM_CREATE, SYS_SHM_DESTROY, SYS_SHM_MAP, SYS_SHM_SIZE, SYS_SHM_UNMAP,
    SYS_SHUTDOWN, SYS_SIGACTION, SYS_SIGPROCMASK, SYS_SIGRETURN, SYS_SLEEP_MS, SYS_SOCKET,
    SYS_SPAWN, SYS_SPAWN2, SYS_STAT, SYS_STATFS, SYS_SYMLINK, SYS_SYMLINKAT, SYS_SYNC,
    ...
    SYS_WINDOW_DESTROY, SYS_WINDOW_GET, SYS_WINDOW_GRANT_SHELL, SYS_WINDOW_LIST, SYS_WINDOW_POLL,
