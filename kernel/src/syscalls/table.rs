...
use super::{
    ...
    SYS_PREAD, SYS_PROFILE_CTL, SYS_PROFILE_READ, SYS_PWRITE, SYS_READ, SYS_READLINK,
    SYS_READLINKAT, SYS_READV, SYS_REBOOT, SYS_RECVFROM, SYS_RENAME, SYS_RENAMEAT, SYS_RMDIR,
    SYS_RMDIR_ALL, SYS_SCHED_GETATTR, SYS_SCHED_SETATTR, SYS_SCHED_YIELD, SYS_SENDTO, SYS_SETDNS,
    SYS_SETPGID, SYS_SETSOCKOPT, SYS_SHM_CREATE, SYS_SHM_DESTROY, SYS_SHM_MAP, SYS_SHM_SIZE,
    SYS_SHM_UNMAP, SYS_SHUTDOWN, SYS_SIGACTION, SYS_SIGPROCMASK, SYS_SIGRETURN, SYS_SLEEP_MS,
    SYS_SOCKET, SYS_SPAWN, SYS_SPAWN2, SYS_STAT, SYS_STATFS, SYS_SYMLINK, SYS_SYMLINKAT, SYS_SYNC,
    SYS_TCGETPGRP, SYS_TCSETPGRP, SYS_TRACE_CTL, SYS_TRACE_READ, SYS_TRUNCATE, SYS_UNLINK,
    SYS_UNLINKAT, SYS_UTIMENSAT, SYS_WAIT_PID, SYS_WINDOW_CREATE, SYS_WINDOW_DAMAGE,
    SYS_WINDOW_DESTROY, SYS_WINDOW_GET, SYS_WINDOW_GRAB_KEY, SYS_WINDOW_GRANT_SHELL,
    SYS_WINDOW_LIST, SYS_WINDOW_POLL, SYS_WINDOW_PRESENT, SYS_WINDOW_SEND_EVENT, SYS_WINDOW_SET,
    SYS_WINDOW_WAIT, SYS_WRITE, SYS_WRITEV,
};
...
pub static SYSCALLS: &[SyscallInfo] = &[
    ...
    sc!(SYS_PROFILE_CTL, "profile_ctl", Int, Len),
    sc!(SYS_PROFILE_READ, "profile_read", Buf, Len, Len),
