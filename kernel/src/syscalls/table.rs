...
use super::{
    ...
    SYS_FSYNC, SYS_FTRUNCATE, SYS_FUTEX_WAIT, SYS_FUTEX_WAKE, SYS_GETCWD, SYS_GETDENTS, SYS_GETDNS,
    SYS_GETGID, SYS_GETPEERNAME, SYS_GETPGID, SYS_GETPID, SYS_GETRANDOM, SYS_GETSOCKNAME,
    SYS_GETSOCKOPT, SYS_GETUID, SYS_IOCTL, SYS_ISATTY, SYS_KILL, SYS_LIST_DIR, SYS_LIST_MOUNTS,
    SYS_LIST_PARTITIONS, SYS_LISTEN, SYS_LSEEK, SYS_MKDIR, SYS_MKDIRAT, SYS_MKFIFOAT, SYS_MMAP,
    SYS_MONOTONIC_TIME, SYS_MOUNT, SYS_MPROTECT, SYS_MSYNC, SYS_MUNMAP, SYS_NANOSLEEP, SYS_NETINFO,
    ...
    SYS_RMDIR, SYS_RMDIR_ALL, SYS_SCHED_GETATTR, SYS_SCHED_SETATTR, SYS_SCHED_YIELD, SYS_SENDTO,
