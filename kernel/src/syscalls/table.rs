...
use super::{
    ...
    SYS_GETCWD, SYS_GETDENTS, SYS_GETDNS, SYS_GETGID, SYS_GETPEERNAME, SYS_GETPGID, SYS_GETPID,
    SYS_GETRANDOM, SYS_GETSOCKNAME, SYS_GETSOCKOPT, SYS_GETUID, SYS_IOCTL, SYS_ISATTY, SYS_KILL,
